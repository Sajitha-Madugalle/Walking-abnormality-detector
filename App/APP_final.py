...
class PressureMapApp(QWidget):
    ...
    def create_folder(self):
        ...
        folder_path = os.path.join(os.getcwd(), patient_name)
        try:
...
class QMainWindow(QWidget):
    ...
    def get_input_path(self, image_label):
        ...
        if input_path:
            output_path = f"{self.patient_name}/{self.patient_name}'s_foot_Mask.png"
    ...
    def show_pressure_distribution(self):
        ...
        update_heatmap(ser, f"{self.patient_name}/{self.patient_name}'s_foot_Mask.png", update_signal, update_interval=0.03)
...
def update_heatmap(ser, mask_image_path, update_signal, update_interval=0.2):
    ...
    sensor_positions = [(43, 130), (30,170), (101,127), (162,127), (84,172), (223, 133), (260,160)]
